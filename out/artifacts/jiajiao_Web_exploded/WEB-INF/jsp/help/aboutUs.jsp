...
<div class="help_center font_15 w_1200 white_bj">
	...
	<div class="r_cell help_r">
		...
		<p>
			&nbsp;
			云朵家教网创立于2025年，是广东领先的专业家教服务网站，是众多教员心目中的品牌平台。
		</p>
		<p>
			&nbsp;
			凭借着强大的互联网技术以及专业咨询团队，云朵家教已然成为广东领先的家教服务网站。云朵家教主要为有需要的用户提供一个方便、快捷、安全的家教信息平台。您可以通过云朵家教网按照自己需求选择合适的家教老师，并且能得到较大限度的优惠。您也可以寻找到适合自己的家教兼职、展现自身能力。
		</p>
		<p>
			&nbsp; 另外我们也以贴心的服务、人性化的功能赢得了良好的口碑，云朵家教致力于成为信息全面、功能优质的家教信息网络平台。
		</p>
		<p>
			云朵家教的业务范围已经覆盖广州，为几万名大学生、老师提供家教机会，为几万名用户找到适合的家教老师，满足了广大用户对于家教、教育等相关信息的直接或潜在的需求。
		</p>
		<p>
			&nbsp;
			在取得成绩的同时我们不断寻求进步，我们将为小班、辅导班、培训班等组织提供平台进行宣传以满足不同学员的各种需求。未来我们将在各版块逐步改进，听取用户的建议和意见，推出更人性化更全面的功能。云朵家教将一如既往地脚踏实地、锐意进取，为打造具有影响力的教育服务平台而努力。
		</p>
		<p>
			对于学员：
		</p>
		...
		<p style="line-height: 26px; margin-bottom: 0px; background: white;">
			...
			<img title="20140630154423_4726.jpg" alt="20140630154423_4726.jpg"
				src="./云朵家教_files/6364826463014502543390741.jpg">
		</p>
	</div>
	<!--end右边-->
</div>
