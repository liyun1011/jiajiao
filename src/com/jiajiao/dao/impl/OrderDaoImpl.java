...
public class OrderDaoImpl implements OrdersDao {
	...
	public List<Orders> findByMemberId(int memberId) {
		...
		String sql = "SELECT a.oId, a.orderCode, b.courseName, a.coursePrice, a.publicTime, orderStatus, IFNULL(c.teacherId, '') teacherId, IFNULL(d.teacherName, '') teacherName,d.phone as contactPhone,a.wxNumber "+
		" FROM "+
		" 	t_orders a "+
