...
public class Orders {
	...
	private int oId;
	private Integer publisher1;// 发布人1 如果发布人1是0的话，代表的是本平台管理员代发布（通过微信、电话联系）。
	private Integer publisher2;// 发布人2 为实际学员发布（后续进行家教订单评价时需要）
	...
	public Integer getPublisher1() {
		return publisher1;
	}

	public void setPublisher1(Integer publisher1) {
		this.publisher1 = publisher1;
	}

	public Integer getPublisher2() {
		return publisher2;
	}

	public void setPublisher2(Integer publisher2) {
