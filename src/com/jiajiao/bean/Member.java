...
public class Member {
	...
	//累计选择授课教员数量
	private int allTeachNum;

	public int getCurrentPushNum() {
		return currentPushNum;
	}

	public void setCurrentPushNum(int currentPushNum) {
		this.currentPushNum = currentPushNum;
	}

	//当前发布需求数量
	private int currentPushNum;

	public int getAllPushNum() {
		return allPushNum;
	}

	public void setAllPushNum(int allPushNum) {
		this.allPushNum = allPushNum;
	}

	public int getAllTeachNum() {
		return allTeachNum;
	}

	public void setAllTeachNum(int allTeachNum) {
		this.allTeachNum = allTeachNum;
	}
