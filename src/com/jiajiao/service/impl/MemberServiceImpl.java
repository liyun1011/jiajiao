...
public class MemberServiceImpl implements MemberService {
	...
	@Override
	public int evaluateTeacher(int score, String evaluationContent, String orderCode,int teacherId, int memberId) {
		return memberDao.evaluateTeacher(score, evaluationContent, orderCode,teacherId, memberId);
	}
}
