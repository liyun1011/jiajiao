...
<script>
    $(".time_table td").click(function () {
        ...
        $("#TimeListId").val(ids);
            ...
            <tr>
                <th>薪酬标准</th>
                <td><input type="text" class="fill_text" id="coursePrice" name="coursePrice" placeholder="若执行广州家教网薪酬标准,请填写 ‘0’ ">&nbsp;&nbsp;&nbsp;&nbsp;元/小时</td>
            </tr>
...
<script type="text/javascript" src="http://api.map.baidu.com/getscript?v=2.0&amp;ak=aSBzW9RUaCp3AM2dvTjR7f4lE7Tqm4wx&amp;services=&amp;t=20190123111209"></script><script type="text/javascript" src="./云朵家教网_免费找家教_【云朵家教网】_广州一对一在线辅导_files/getscript"></script>
