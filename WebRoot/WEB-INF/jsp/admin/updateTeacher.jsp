                ...
                <tbody>
                    ...
                    <tr>
		                ...
		                <td>
							...
							<a data-id="6" href="javascript:void(0)" class="round_m">
								白云区
							</a>
							<%} %>
							<%if(ArrayHelper.inArray(teachingAreas,"7")){ %>
							<a data-id="7" href="javascript:void(0)" class="round_m">
								花都区
							</a>
							<%} %>
							<%if(ArrayHelper.inArray(teachingAreas,"8")){ %>
							<a data-id="8" href="javascript:void(0)" class="round_m">
								荔湾区
							</a>
							<%} %>
							<%if(ArrayHelper.inArray(teachingAreas,"9")){ %>
							<a data-id="9" href="javascript:void(0)" class="round_m">
								南沙区
							</a>
							<%} %>
							<%if(ArrayHelper.inArray(teachingAreas,"10")){ %>
							<a data-id="10" href="javascript:void(0)" class="round_m">
								从化区
							</a>
							<%} %>
							<%if(ArrayHelper.inArray(teachingAreas,"11")){ %>
							<a data-id="11" href="javascript:void(0)" class="round_m">
								增城区
							</a>
							<%} %>
