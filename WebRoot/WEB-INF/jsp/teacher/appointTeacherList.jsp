					...
					<div>
						<table class="list_table hover_table">
							...
							%>
									...
									海珠区
									<%}else if(orderTeacher.getAreaId()==6){%>
									白云区
									<%}else if(orderTeacher.getAreaId()==7){%>
									花都区
									<%}else if(orderTeacher.getAreaId()==8){%>
									荔湾区
									<%}else if(orderTeacher.getAreaId()==9){%>
									南沙区
									<%}else if(orderTeacher.getAreaId()==10){%>
									从化区
									<%}else if(orderTeacher.getAreaId()==11){%>
									增城区
									<%} %></td>
