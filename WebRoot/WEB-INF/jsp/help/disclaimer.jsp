...
<div class="help_center font_15 w_1200 white_bj">
	...
	<div class="r_cell help_r">
		...
		<p>
			如发生以下情况，云朵家教不对用户的直接或间接损失承担法律责任:
		</p>
		<br />
		<p>
			1、不可抗力事件导致的服务中断或云朵家教无法控制的原因所导致的用户损失，云朵家教不承担任何责任。
		</p>
		<br />
		<p>
			2、云朵家教系信息服务平台，不保证该等信息的准确性、有效性、及时性或 完整性。提供信息的真实性、合法性等由信息提供者承担相关法律责任。
		</p>
		<br />
		<p>
		...
		<br />
		<p>
			4、用户使用云朵家教站（包括链接到第三方网站或自第三方网站链接）而可能产生的计算机病毒、黑客入侵、系统失灵或功能紊乱等导致的用户损失，云朵家教网不承担任何责任。
		</p>
		<br />
		<p>
		...
		<br />
		<p>
			6、云朵家教对于任何信息和其他通信或其他本服务所保留或传输的内容的删
			除或存储失败，不承担任何责任。云朵家教对于那些经过延长期限仍未重新使用的暂停帐户保留取消的权利，并可随时自主决定，发出或无须通知。
		</p>
		<br/>
		<p>
			7、如因系统维护或升级而需要暂停网络服务，云朵家教将尽可能事先在网站进行通知。
		</p>
		<br />
		<p>
			8、云朵家教平台主张次结课时费，若教员与家长之间因协商非次结而导致的 经济纠纷云朵家教平台概不负责。
		</p>
		<br />
		<p>
			9、云朵家教仅负责提供家教信息，不承担家教信息以外的其它责任。
		</p>
		<br/>
		<p>
